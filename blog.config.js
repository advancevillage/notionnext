...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '黎明', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '当机器会思考时，会不会失业？！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sunhe.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '黎明, 博客', // 网站关键词 英文逗号隔开
  ...
  MERMAID_CDN:
    ...
    'https://cdnjs.cloudflare.com/ajax/libs/mermaid/11.3.0/mermaid.min.js', // CDN
  // QRCodeCDN
  QR_CODE_CDN:
